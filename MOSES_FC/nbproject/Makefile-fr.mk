...
# C Compiler Flags
CFLAGS=-march=i486 -O2 -Werror -Wall
...
LDLIBSOPTIONS=-lm -lpthread -ldl -lcurses
...
${OBJECTDIR}/lockingQueue.o: lockingQueue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/lockingQueue.o lockingQueue.c
...
${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -lm -pthread -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.c
...
${OBJECTDIR}/plx/Aardvark.o: plx/Aardvark.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/plx/Aardvark.o plx/Aardvark.c

${OBJECTDIR}/plx/ConsFunc.o: plx/ConsFunc.c 
	${MKDIR} -p ${OBJECTDIR}/plx
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/plx/ConsFunc.o plx/ConsFunc.c

${OBJECTDIR}/plx/Eep_8000.o: plx/Eep_8000.c 
	${MKDIR} -p ${OBJECTDIR}/plx
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/plx/Eep_8000.o plx/Eep_8000.c

${OBJECTDIR}/plx/PlxApi.o: plx/PlxApi.c 
	${MKDIR} -p ${OBJECTDIR}/plx
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/plx/PlxApi.o plx/PlxApi.c

${OBJECTDIR}/plx/PlxApiI2cAa.o: plx/PlxApiI2cAa.c 
	${MKDIR} -p ${OBJECTDIR}/plx
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/plx/PlxApiI2cAa.o plx/PlxApiI2cAa.c
...
${OBJECTDIR}/sci_timeline_funcs.o: sci_timeline_funcs.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sci_timeline_funcs.o sci_timeline_funcs.c

${OBJECTDIR}/science_timeline.o: science_timeline.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/science_timeline.o science_timeline.c
