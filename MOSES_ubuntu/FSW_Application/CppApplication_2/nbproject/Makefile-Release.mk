...
${OBJECTDIR}/EMSim.o: EMSim.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EMSim.o EMSim.c
...
${OBJECTDIR}/dioboardSim.o: dioboardSim.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dioboardSim.o dioboardSim.c
...
${OBJECTDIR}/roeImage.o: roeImage.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/roeImage.o roeImage.c
...
${OBJECTDIR}/scienceTimeline.o: scienceTimeline.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scienceTimeline.o scienceTimeline.c

${OBJECTDIR}/scienceTimelineFuncs.o: scienceTimelineFuncs.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scienceTimelineFuncs.o scienceTimelineFuncs.c
