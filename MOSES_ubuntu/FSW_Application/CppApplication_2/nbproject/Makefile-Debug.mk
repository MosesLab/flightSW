...
OBJECTFILES= \
	...
	${OBJECTDIR}/dioboardSim.o \
	${OBJECTDIR}/hashTable.o \
	${OBJECTDIR}/lockingQueue.o \
	${OBJECTDIR}/logger.o \
	${OBJECTDIR}/main.o \
	${OBJECTDIR}/packet.o \
	${OBJECTDIR}/roeImage.o \
	${OBJECTDIR}/roeReal.o \
	${OBJECTDIR}/roeSim.o \
	${OBJECTDIR}/scienceTimeline.o \
	${OBJECTDIR}/scienceTimelineFuncs.o \
...
${OBJECTDIR}/EMSim.o: EMSim.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EMSim.o EMSim.c
...
${OBJECTDIR}/dioboardSim.o: dioboardSim.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dioboardSim.o dioboardSim.c
...
${OBJECTDIR}/roeImage.o: roeImage.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/roeImage.o roeImage.c

${OBJECTDIR}/roeReal.o: roeReal.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/roeReal.o roeReal.c
...
${OBJECTDIR}/scienceTimeline.o: scienceTimeline.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scienceTimeline.o scienceTimeline.c

${OBJECTDIR}/scienceTimelineFuncs.o: scienceTimelineFuncs.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/scienceTimelineFuncs.o scienceTimelineFuncs.c
